      ...
      "organisms": [
        {
          "id": "org-10",
          "type": "list",
          "organismName": "OrderQueue",
          "titleKey": "posWorkspace.organism.queue.title",
          "purpose": "Fila de pedidos em tempo real com prioridade e status.",
          "userActions": [
            "viewOrderBoard"
          ],
          "requiredEntities": [
            ...
            "intentions": [
              {
                ...
                "intent": "queryList",
                "order": 10,
                "titleKey": "posWorkspace.intent.queue.title",
