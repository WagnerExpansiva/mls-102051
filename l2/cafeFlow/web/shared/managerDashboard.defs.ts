...
export const definition = {
  ...
  "layoutRef": {
    ...
    "layoutId": "page11_status_overview"
  },
  "states": [
    {
  ...
  "i18n": {
    ...
    "section.aiSales.title": "Resumo de Vendas por IA",
    "section.aiPromo.title": "Sugestões de Promoção por IA",
    "section.review.title": "Revisão Consolidada",
    "intention.dashboard.title": "Métricas e status dos pedidos do turno atual",
    "intention.aiSales.title": "Resumo de vendas gerado pelo assistente IA",
    "intention.aiPromo.title": "Sugestões de promoção geradas pelo assistente IA",
    "intention.review.title": "Visão consolidada do dashboard e sugestões IA",
    ...
    "action.requestAiSalesSummary.label": "Solicitar resumo de vendas IA",
    "action.requestAiPromoSuggestions.label": "Solicitar sugestões de promoção IA",
    "action.viewDashboard.success": "Dashboard atualizado com sucesso.",
    "action.viewDashboard.error": "Erro ao carregar o dashboard. Tente novamente.",
    "action.requestAiSalesSummary.success": "Resumo de vendas gerado com sucesso.",
    "action.requestAiSalesSummary.error": "Erro ao gerar o resumo de vendas. Tente novamente.",
    "action.requestAiPromoSuggestions.success": "Sugestões de promoção geradas com sucesso.",
    "action.requestAiPromoSuggestions.error": "Erro ao gerar sugestões de promoção. Tente novamente.",
    "empty.dashboard": "Nenhum dado disponível para o dashboard do dia.",
    "empty.aiSales": "Nenhum resumo de vendas disponível. Solicite ao assistente IA.",
    "empty.aiPromo": "Nenhuma sugestão de promoção disponível. Solicite ao assistente IA.",
    "empty.review": "Nenhum dado consolidado para revisão.",
    "sec.dashboard.title": "Sec dashboard",
    "org.dashboard.metrics.title": "Exibir métricas e grupos de status do dashboard do dia — vendas, pedidos por tipo, alertas de estoque baixo",
    "sec.ai.sales.title": "Sec ai sales",
    "org.ai.sales.summary.title": "Painel do assistente IA que exibe o resumo de vendas do dia corrente, agregando pedidos e estoque do turno ativo",
    "sec.ai.promo.title": "Sec ai promo",
    "org.ai.promo.suggestions.title": "Painel do assistente IA que exibe sugestões de promoção por item, baseadas em pedidos dos últimos 7 dias e níveis atuais de estoque",
    "sec.review.title": "Sec review",
    "org.review.summary.title": "Revisar o contexto consolidado do dashboard, do resumo de vendas IA e das sugestões de promoção IA para decisão gerencial",
    "section.dashboardOverview.title": "Dashboard do Dia",
    "section.aiAssistant.title": "Assistente IA",
    "organism.dashboardSummary.title": "Resumo Operacional do Turno",
    ...
    "action.viewDashboard.refresh": "Atualizar Dashboard",
    "action.requestAiSalesSummary.request": "Solicitar Resumo de Vendas",
    "action.requestAiPromoSuggestions.request": "Solicitar Sugestões de Promoção",
    "empty.viewDashboard": "Nenhum dado do dashboard disponível para o turno atual.",
    "empty.requestAiSalesSummary": "Toque em 'Solicitar Resumo de Vendas' para gerar o resumo por IA.",
    "empty.requestAiPromoSuggestions": "Toque em 'Solicitar Sugestões de Promoção' para gerar sugestões por IA.",
    "dashboardOverview.title": "Dashboard Overview",
    "dashboardSummary.title": "Exibir resumo do dia com pedidos agregados do turno atual, distribuição de status e alertas de estoque baixo",
    "aiAssistant.title": "Ai Assistant",
    "aiSalesSummary.title": "Permitir ao gerente solicitar e visualizar o resumo de vendas gerado pelo assistente IA para o turno atual",
    "aiPromoSuggestions.title": "Permitir ao gerente acionar o assistente IA para obter sugestões de promoção e visualizá las para decidir ações de marketing"
  },
  "automation": {
