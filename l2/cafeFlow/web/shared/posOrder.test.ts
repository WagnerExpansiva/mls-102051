...
type _Action_createOrder = Assert<Assignable<typeof page.createOrder, (...args: any[]) => unknown>>;
type _Handler_handleCreateOrderClick = Assert<Assignable<typeof page.handleCreateOrderClick, (...args: any[]) => unknown>>;
type _Action_loadViewOrderBoard = Assert<Assignable<typeof page.loadViewOrderBoard, (...args: any[]) => unknown>>;
type _Handler_handleViewOrderBoardClick = Assert<Assignable<typeof page.handleViewOrderBoardClick, (...args: any[]) => unknown>>;
type _Action_deliverOrder = Assert<Assignable<typeof page.deliverOrder, (...args: any[]) => unknown>>;
type _Handler_handleDeliverOrderClick = Assert<Assignable<typeof page.handleDeliverOrderClick, (...args: any[]) => unknown>>;
type _Action_setCreateOrderOrderType = Assert<Assignable<typeof page.setCreateOrderOrderType, (...args: any[]) => unknown>>;
type _Handler_handleCreateOrderOrderTypeChange = Assert<Assignable<typeof page.handleCreateOrderOrderTypeChange, (...args: any[]) => unknown>>;
type _Action_setCreateOrderTableNumber = Assert<Assignable<typeof page.setCreateOrderTableNumber, (...args: any[]) => unknown>>;
type _Handler_handleCreateOrderTableNumberChange = Assert<Assignable<typeof page.handleCreateOrderTableNumberChange, (...args: any[]) => unknown>>;
type _Action_setCreateOrderPriority = Assert<Assignable<typeof page.setCreateOrderPriority, (...args: any[]) => unknown>>;
type _Handler_handleCreateOrderPriorityChange = Assert<Assignable<typeof page.handleCreateOrderPriorityChange, (...args: any[]) => unknown>>;
type _Action_setCreateOrderPriorityReason = Assert<Assignable<typeof page.setCreateOrderPriorityReason, (...args: any[]) => unknown>>;
type _Handler_handleCreateOrderPriorityReasonChange = Assert<Assignable<typeof page.handleCreateOrderPriorityReasonChange, (...args: any[]) => unknown>>;
type _Action_setViewOrderBoardStatusFilter = Assert<Assignable<typeof page.setViewOrderBoardStatusFilter, (...args: any[]) => unknown>>;
type _Handler_handleViewOrderBoardStatusFilterChange = Assert<Assignable<typeof page.handleViewOrderBoardStatusFilterChange, (...args: any[]) => unknown>>;
